package com.hfs.materialhome.widgets;
...
public class ExpandableTextView extends TextView {
    ...
    //是否换行
    private boolean mNewline = SHOW_NEW_LINE;
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            } else if (attr == R.styleable.ExpandableTextView_etv_Newline) {
                mNewline = a.getBoolean(attr, SHOW_NEW_LINE);
            }
        }
        a.recycle();
    }
